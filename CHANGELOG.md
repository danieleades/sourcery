...
## [0.3.0](https://github.com/danieleades/sourcery/compare/sourcery-v0.2.0...sourcery-v0.3.0) - 2026-02-23
...
- *(ci)* fix typo in project metadata category slug ([#32](https://github.com/danieleades/sourcery/pull/32))
